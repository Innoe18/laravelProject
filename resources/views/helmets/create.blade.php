...
<div class="w-4/5 mx-auto text-left">
    <div class="py-10">
        <h1 class="text-5xl font-bold text-purple-600 text-center">Add New Helmet</h1>
    </div>
</div>
...
<div class="w-4/5 mx-auto pt-10">
    <form action="{{ route('helmets.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <input 
            type="text"
            name="title"
            placeholder="Helmet Title..."
        ...
        <textarea 
            name="inspiration"
            placeholder="Inspiration for the helmet..."
            class="py-10 bg-transparent block border-b-2 border-purple-300 w-full h-40 text-xl text-gray-700 outline-none focus:ring-2 focus:ring-pink-300 transition duration-300"></textarea>
